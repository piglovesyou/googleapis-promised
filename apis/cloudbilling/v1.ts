 ...
 * @memberOf! cloudbilling(v1)
 * @type object
* @property {integer} aggregationCount The number of intervals to aggregate over.
 ...
 * @memberOf! cloudbilling(v1)
 * @type object
* @property {string} displayName The display name given to the billing account, such as `My Billing
Account`. This name is displayed in the Google Cloud Console.
* @property {string} name The resource name of the billing account. The resource name has the form
`billingAccounts/{billing_account_id}`. For example,
`billingAccounts/012345-567890-ABCDEF` would be the resource name for
billing account `012345-567890-ABCDEF`.
* @property {boolean} open True if the billing account is open, and will therefore be charged for any
 ...
 * @memberOf! cloudbilling(v1)
 * @type object
* @property {string} resourceFamily The type of product the SKU refers to.
Example: &quot;Compute&quot;, &quot;Storage&quot;, &quot;Network&quot;, &quot;ApplicationServices&quot; etc.
* @property {string} resourceGroup A group classification for related SKUs.
Example: &quot;RAM&quot;, &quot;GPU&quot;, &quot;Prediction&quot;, &quot;Ops&quot;, &quot;GoogleEgress&quot; etc.
* @property {string} serviceDisplayName The display name of the service this SKU belongs to.
* @property {string} usageType Represents how the SKU is consumed.
...
* @property {string} nextPageToken A token to retrieve the next page of results. To retrieve the next page,
...
value. This field is empty if there are no more results to retrieve.
* @property {cloudbilling(v1).ProjectBillingInfo[]} projectBillingInfo A list of `ProjectBillingInfo` resources representing the projects
 ...
 * @memberOf! cloudbilling(v1)
 * @type object
* @property {string} baseUnit The base unit for the SKU which is the unit used in usage exports.
Example: &quot;By&quot;
* @property {number} baseUnitConversionFactor Conversion factor for converting from price per usage_unit to price per
base_unit, and start_usage_amount to start_usage_amount in base_unit.
unit_price / base_unit_conversion_factor = price per base_unit.
start_usage_amount * base_unit_conversion_factor = start_usage_amount in
base_unit.
* @property {string} baseUnitDescription The base unit in human readable form.
Example: &quot;byte&quot;.
* @property {number} displayQuantity The recommended quantity of units for displaying pricing info. When
...
* @property {cloudbilling(v1).TierRate[]} tieredRates The list of tiered rates for this pricing. The total cost is computed by
applying each of the tiered rates on usage. This repeated list is sorted
by ascending order of start_usage_amount.
* @property {string} usageUnit The short hand for unit of usage this pricing is specified in.
Example: usage_unit of &quot;GiBy&quot; means that usage is specified in &quot;Gibi Byte&quot;.
* @property {string} usageUnitDescription The unit of usage in human readable form.
Example: &quot;gibi byte&quot;.
*/
 ...
 * @memberOf! cloudbilling(v1)
 * @type object
* @property {cloudbilling(v1).AggregationInfo} aggregationInfo Aggregation Info. This can be left unspecified if the pricing expression
doesn&#39;t require aggregation.
* @property {number} currencyConversionRate Conversion rate for currency conversion, from USD to the currency specified
...
* @property {string} summary An optional human readable summary of the pricing information, has a
 ...
 * @memberOf! cloudbilling(v1)
 * @type object
* @property {string} billingAccountName The resource name of the billing account associated with the project, if
any. For example, `billingAccounts/012345-567890-ABCDEF`.
* @property {boolean} billingEnabled True if the project is associated with an open billing account, to which
usage on the project is charged. False if the project is associated with a
closed billing account, or no billing account at all, and therefore cannot
use paid services. This field is read-only.
* @property {string} name The resource name for the `ProjectBillingInfo`; has the form
`projects/{project_id}/billingInfo`. For example, the resource name for the
billing information for project `tokyo-rain-123` would be
`projects/tokyo-rain-123/billingInfo`. This field is read-only.
* @property {string} projectId The ID of the project that this `ProjectBillingInfo` represents, such as
...
* @property {string} name The resource name for the service.
Example: &quot;services/DA34-426B-A397&quot;
* @property {string} serviceId The identifier for the service.
...
* @property {string} description A human readable description of the SKU, has a maximum length of 256
characters.
* @property {string} name The resource name for the SKU.
...
* @property {string} serviceProviderName Identifies the service provider.
This is &#39;Google&#39; for first party services in Google Cloud Platform.
* @property {string[]} serviceRegions List of service regions this SKU is offered at.
Example: &quot;asia-east1&quot;
Service regions can be found at https://cloud.google.com/about/locations/
* @property {string} skuId The identifier for the SKU.
 ...
 * @memberOf! cloudbilling(v1)
 * @type object
* @property {number} startUsageAmount Usage is priced at this rate only after this amount.
Example: start_usage_amount of 10 indicates that the usage will be priced
at the unit_price after the first 10 usage_units.
* @property {cloudbilling(v1).Money} unitPrice The price per unit of usage.
