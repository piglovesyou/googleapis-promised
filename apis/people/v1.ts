...
* @property {string} formattedName The read-only name translated and formatted in the viewer&#39;s account locale
or the `Accept-Language` HTTP header locale for system groups names.
Group names set by the owner are the same as name.
* @property {string} groupType The read-only contact group type.
* @property {integer} memberCount The total number of contacts in the group irrespective of max members in
specified in the request.
* @property {string[]} memberResourceNames The list of contact person resource names that are members of the contact
group. The field is not populated for LIST requests and can only be updated
through the
[ModifyContactGroupMembers](/people/api/rest/v1/contactgroups/members/modify).
* @property {people(v1).ContactGroupMetadata} metadata Metadata about the contact group.
* @property {string} name The contact group name set by the group owner or a system provided name
for system groups.
* @property {string} resourceName The resource name for the contact group, assigned by the server. An ASCII
 ...
 * @memberOf! people(v1)
 * @type object
* @property {boolean} deleted True if the contact group resource has been deleted. Populated only for
 ...
 * @memberOf! people(v1)
 * @type object
* @property {people(v1).ContactGroup[]} contactGroups The list of contact groups. Members of the contact groups are not
populated.
* @property {string} nextPageToken The token that can be used to retrieve the next page of results.
* @property {string} nextSyncToken The token that can be used to retrieve changes since the last request.
* @property {integer} totalItems The total number of items in the list without pagination.
 ...
 * @memberOf! people(v1)
 * @type object
* @property {string[]} resourceNamesToAdd The resource names of the contact people to add in the form of in the form
`people/`&lt;var&gt;person_id&lt;/var&gt;.
* @property {string[]} resourceNamesToRemove The resource names of the contact people to remove in the form of in the
 ...
 * @memberOf! people(v1)
 * @type object
* @property {string} etag **Only populated in `person.metadata.sources`.**

The [HTTP entity tag](https://en.wikipedia.org/wiki/HTTP_ETag) of the
source. Used for web cache validation.
* @property {string} id The unique identifier within the source type generated by the server.
* @property {people(v1).ProfileMetadata} profileMetadata **Only populated in `person.metadata.sources`.**

Metadata about a source of type PROFILE.
* @property {string} type The source type.
* @property {string} updateTime **Only populated in `person.metadata.sources`.**
