 ...
 */
function Streetviewpublish(options) { // eslint-disable-line
  const self = this;
 ...
 * @memberOf! streetviewpublish(v1)
 * @type object
* @property {streetviewpublish(v1).PhotoResponse[]} results List of results for each individual
 ...
 * @memberOf! streetviewpublish(v1)
 * @type object
* @property {string} name Required. A name assigned to this Level, restricted to 3 characters.
Consider how the elevator buttons would be labeled for this level if there
was an elevator.
* @property {number} number Floor number, used for ordering. 0 indicates the ground level, 1 indicates
