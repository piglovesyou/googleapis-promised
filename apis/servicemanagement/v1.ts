 ...
 * @memberOf! servicemanagement(v1)
 * @type object
* @property {servicemanagement(v1).Expr} condition The condition that is associated with this binding.
...
* @property {servicemanagement(v1).CustomHttpPattern} custom The custom pattern is used for specifying an HTTP method that is not
...
Used by metric-based quotas only.
* @property {object} values Tiered limit values, currently only STANDARD is supported.
*/
